...
@enum object _artDataContent_DataTypeId {
   ...
   "thermostatThermostat_PostState_Container_P_Id"
   "thermostatThermostat_PreState_Container_P_Id"
}
...
@enum object thermostatThermostat_PreState_Container_DataTypeId {
   "thermostatThermostat_PreState_Container_P_Id"
}

@enum object thermostatThermostat_PostState_Container_DataTypeId {
   "thermostatThermostat_PostState_Container_P_Id"
}
