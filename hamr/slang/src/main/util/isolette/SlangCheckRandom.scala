...
@msig trait RandomLibI {
  ...
  def next_artDataContent(): art.DataContent = {
    ...
    var v: art.DataContent = c match {
      ...
      case _artDataContent_DataTypeId.thermostatThermostat_PostState_Container_P_Id => (nextthermostatThermostat_PostState_Container_P _).apply()
      case _artDataContent_DataTypeId.thermostatThermostat_PreState_Container_P_Id => (nextthermostatThermostat_PreState_Container_P _).apply()
  ...
  def set_Config_thermostatThermostat_PreState_Container(config: Config_thermostatThermostat_PreState_Container): RandomLib

  def nextthermostatThermostat_PreState_Container(): thermostat.Thermostat_PreState_Container = {
    var callEnum: ISZ[thermostatThermostat_PreState_Container_DataTypeId.Type] = ISZ(thermostatThermostat_PreState_Container_DataTypeId.thermostatThermostat_PreState_Container_P_Id)

    if(get_Config_thermostatThermostat_PreState_Container.additiveTypeFiltering) {
       callEnum = get_Config_thermostatThermostat_PreState_Container.typeFilter
    } else {
       for(h <- get_Config_thermostatThermostat_PreState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: thermostat.Thermostat_PreState_Container = c match {
      case thermostatThermostat_PreState_Container_DataTypeId.thermostatThermostat_PreState_Container_P_Id => (nextthermostatThermostat_PreState_Container_P _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_thermostatThermostat_PreState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_thermostatThermostat_PreState_Container.attempts) {
       if(get_Config_thermostatThermostat_PreState_Container.filter(v)) {
        return v
       }
       if (get_Config_thermostatThermostat_PreState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= thermostat.Thermostat_PreState_Container_P ===================

  def get_Config_thermostatThermostat_PreState_Container_P: Config_thermostatThermostat_PreState_Container_P
  def set_Config_thermostatThermostat_PreState_Container_P(config: Config_thermostatThermostat_PreState_Container_P): RandomLib

  def nextthermostatThermostat_PreState_Container_P(): thermostat.Thermostat_PreState_Container_P = {
    var api_lower_alarm_tempWstatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var api_upper_alarm_tempWstatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var api_current_tempWstatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var api_lower_desired_tempWstatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    ...
    var v: thermostat.Thermostat_PreState_Container_P = thermostat.Thermostat_PreState_Container_P(api_lower_alarm_tempWstatus, api_upper_alarm_tempWstatus, api_current_tempWstatus, api_lower_desired_tempWstatus, api_upper_desired_tempWstatus)

    if(get_Config_thermostatThermostat_PreState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_thermostatThermostat_PreState_Container_P.attempts) {
        if(get_Config_thermostatThermostat_PreState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_thermostatThermostat_PreState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_lower_alarm_tempWstatus = nextIsolette_Data_ModelTempWstatus_impl()
        api_upper_alarm_tempWstatus = nextIsolette_Data_ModelTempWstatus_impl()
        ...
        api_lower_desired_tempWstatus = nextIsolette_Data_ModelTempWstatus_impl()
        api_upper_desired_tempWstatus = nextIsolette_Data_ModelTempWstatus_impl()
        v = thermostat.Thermostat_PreState_Container_P(api_lower_alarm_tempWstatus, api_upper_alarm_tempWstatus, api_current_tempWstatus, api_lower_desired_tempWstatus, api_upper_desired_tempWstatus)
     }
    } else {
     while(T) {
       if(get_Config_thermostatThermostat_PreState_Container_P.filter(v)) {
  ...
  // ============= thermostat.Thermostat_PostState_Container ===================

  def get_Config_thermostatThermostat_PostState_Container: Config_thermostatThermostat_PostState_Container
  def set_Config_thermostatThermostat_PostState_Container(config: Config_thermostatThermostat_PostState_Container): RandomLib

  def nextthermostatThermostat_PostState_Container(): thermostat.Thermostat_PostState_Container = {
    var callEnum: ISZ[thermostatThermostat_PostState_Container_DataTypeId.Type] = ISZ(thermostatThermostat_PostState_Container_DataTypeId.thermostatThermostat_PostState_Container_P_Id)

    if(get_Config_thermostatThermostat_PostState_Container.additiveTypeFiltering) {
       callEnum = get_Config_thermostatThermostat_PostState_Container.typeFilter
    } else {
       for(h <- get_Config_thermostatThermostat_PostState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: thermostat.Thermostat_PostState_Container = c match {
      case thermostatThermostat_PostState_Container_DataTypeId.thermostatThermostat_PostState_Container_P_Id => (nextthermostatThermostat_PostState_Container_P _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_thermostatThermostat_PostState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_thermostatThermostat_PostState_Container.attempts) {
       if(get_Config_thermostatThermostat_PostState_Container.filter(v)) {
        return v
       }
       if (get_Config_thermostatThermostat_PostState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= thermostat.Thermostat_PostState_Container_P ===================

  def get_Config_thermostatThermostat_PostState_Container_P: Config_thermostatThermostat_PostState_Container_P
  ...
  def nextthermostatThermostat_PostState_Container_P(): thermostat.Thermostat_PostState_Container_P = {
    var api_monitor_status: Isolette_Data_Model.Status.Type = nextIsolette_Data_ModelStatusType()
    var api_alarm_control: Isolette_Data_Model.On_Off.Type = nextIsolette_Data_ModelOn_OffType()
    var api_heat_control: Isolette_Data_Model.On_Off.Type = nextIsolette_Data_ModelOn_OffType()
    var api_display_temp: Isolette_Data_Model.Temp_impl = nextIsolette_Data_ModelTemp_impl()
    var api_regulator_status: Isolette_Data_Model.Status.Type = nextIsolette_Data_ModelStatusType()

    var v: thermostat.Thermostat_PostState_Container_P = thermostat.Thermostat_PostState_Container_P(api_monitor_status, api_alarm_control, api_heat_control, api_display_temp, api_regulator_status)

    if(get_Config_thermostatThermostat_PostState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_thermostatThermostat_PostState_Container_P.attempts) {
        if(get_Config_thermostatThermostat_PostState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_thermostatThermostat_PostState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_monitor_status = nextIsolette_Data_ModelStatusType()
        api_alarm_control = nextIsolette_Data_ModelOn_OffType()
        api_heat_control = nextIsolette_Data_ModelOn_OffType()
        api_display_temp = nextIsolette_Data_ModelTemp_impl()
        api_regulator_status = nextIsolette_Data_ModelStatusType()
        v = thermostat.Thermostat_PostState_Container_P(api_monitor_status, api_alarm_control, api_heat_control, api_display_temp, api_regulator_status)
     }
    } else {
     while(T) {
       if(get_Config_thermostatThermostat_PostState_Container_P.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_thermostatThermostat_PreState_Container: Config_thermostatThermostat_PreState_Container = Config_thermostatThermostat_PreState_Container(100, _verbose, F, ISZ(), alwaysTrue_thermostatThermostat_PreState_Container _)

  def get_Config_thermostatThermostat_PreState_Container: Config_thermostatThermostat_PreState_Container = {return config_thermostatThermostat_PreState_Container}

  def set_Config_thermostatThermostat_PreState_Container(config: Config_thermostatThermostat_PreState_Container): RandomLib ={
    config_thermostatThermostat_PreState_Container = config
    return this
  }

  // ============= thermostat.Thermostat_PreState_Container_P ===================
  def alwaysTrue_thermostatThermostat_PreState_Container_P(v: thermostat.Thermostat_PreState_Container_P): B = {return T}

  var config_thermostatThermostat_PreState_Container_P: Config_thermostatThermostat_PreState_Container_P = Config_thermostatThermostat_PreState_Container_P(100, _verbose, alwaysTrue_thermostatThermostat_PreState_Container_P _)

  def get_Config_thermostatThermostat_PreState_Container_P: Config_thermostatThermostat_PreState_Container_P = {return config_thermostatThermostat_PreState_Container_P}

  def set_Config_thermostatThermostat_PreState_Container_P(config: Config_thermostatThermostat_PreState_Container_P): RandomLib ={
    config_thermostatThermostat_PreState_Container_P = config
    return this
  }

  // ============= thermostat.Thermostat_PostState_Container ===================
  def alwaysTrue_thermostatThermostat_PostState_Container(v: thermostat.Thermostat_PostState_Container): B = {return T}

  var config_thermostatThermostat_PostState_Container: Config_thermostatThermostat_PostState_Container = Config_thermostatThermostat_PostState_Container(100, _verbose, F, ISZ(), alwaysTrue_thermostatThermostat_PostState_Container _)

  def get_Config_thermostatThermostat_PostState_Container: Config_thermostatThermostat_PostState_Container = {return config_thermostatThermostat_PostState_Container}

  def set_Config_thermostatThermostat_PostState_Container(config: Config_thermostatThermostat_PostState_Container): RandomLib ={
    config_thermostatThermostat_PostState_Container = config
    return this
  }

  // ============= thermostat.Thermostat_PostState_Container_P ===================
  def alwaysTrue_thermostatThermostat_PostState_Container_P(v: thermostat.Thermostat_PostState_Container_P): B = {return T}

  var config_thermostatThermostat_PostState_Container_P: Config_thermostatThermostat_PostState_Container_P = Config_thermostatThermostat_PostState_Container_P(100, _verbose, alwaysTrue_thermostatThermostat_PostState_Container_P _)

  def get_Config_thermostatThermostat_PostState_Container_P: Config_thermostatThermostat_PostState_Container_P = {return config_thermostatThermostat_PostState_Container_P}
