...
object JSON {
  ...
  object Printer {
    ...
    @pure def print_artDataContent(o: art.DataContent): ST = {
      o match {
        ...
        case o: thermostat.Thermostat_PreState_Container_P => return printthermostatThermostat_PreState_Container_P(o)
        case o: thermostat.Thermostat_PostState_Container_P => return printthermostatThermostat_PostState_Container_P(o)
    ...
    @pure def printthermostatThermostat_PreState_Container(o: thermostat.Thermostat_PreState_Container): ST = {
      o match {
        case o: thermostat.Thermostat_PreState_Container_P => return printthermostatThermostat_PreState_Container_P(o)
      }
    }

    @pure def printthermostatThermostat_PreState_Container_P(o: thermostat.Thermostat_PreState_Container_P): ST = {
      return printObject(ISZ(
        ("type", st""""thermostat.Thermostat_PreState_Container_P""""),
        ("api_lower_alarm_tempWstatus", printIsolette_Data_ModelTempWstatus_impl(o.api_lower_alarm_tempWstatus)),
        ("api_upper_alarm_tempWstatus", printIsolette_Data_ModelTempWstatus_impl(o.api_upper_alarm_tempWstatus)),
        ("api_current_tempWstatus", printIsolette_Data_ModelTempWstatus_impl(o.api_current_tempWstatus)),
        ("api_lower_desired_tempWstatus", printIsolette_Data_ModelTempWstatus_impl(o.api_lower_desired_tempWstatus)),
    ...
    @pure def printthermostatThermostat_PostState_Container(o: thermostat.Thermostat_PostState_Container): ST = {
      o match {
        case o: thermostat.Thermostat_PostState_Container_P => return printthermostatThermostat_PostState_Container_P(o)
      }
    }

    @pure def printthermostatThermostat_PostState_Container_P(o: thermostat.Thermostat_PostState_Container_P): ST = {
      return printObject(ISZ(
        ("type", st""""thermostat.Thermostat_PostState_Container_P""""),
        ("api_monitor_status", printIsolette_Data_ModelStatusType(o.api_monitor_status)),
        ("api_alarm_control", printIsolette_Data_ModelOn_OffType(o.api_alarm_control)),
        ("api_heat_control", printIsolette_Data_ModelOn_OffType(o.api_heat_control)),
        ("api_display_temp", printIsolette_Data_ModelTemp_impl(o.api_display_temp)),
        ("api_regulator_status", printIsolette_Data_ModelStatusType(o.api_regulator_status))
      ))
    }

    @pure def printsystem_testsjohn1SystemTestsJohn__Container(o: system_tests.john1.SystemTestsJohn__Container): ST = {
      return printObject(ISZ(
        ("type", st""""system_tests.john1.SystemTestsJohn__Container""""),
  ...
  @record class Parser(val input: String) {
    ...
    def parse_artDataContent(): art.DataContent = {
      ...
      t.native match {
        ...
        case "thermostat.Thermostat_PreState_Container_P" => val r = parsethermostatThermostat_PreState_Container_PT(T); return r
        case "thermostat.Thermostat_PostState_Container_P" => val r = parsethermostatThermostat_PostState_Container_PT(T); return r
    ...
    def parsethermostatThermostat_PreState_Container(): thermostat.Thermostat_PreState_Container = {
      val t = parser.parseObjectTypes(ISZ("thermostat.Thermostat_PreState_Container_P"))
      t.native match {
        case "thermostat.Thermostat_PreState_Container_P" => val r = parsethermostatThermostat_PreState_Container_PT(T); return r
        case _ => val r = parsethermostatThermostat_PreState_Container_PT(T); return r
      }
    }

    def parsethermostatThermostat_PreState_Container_P(): thermostat.Thermostat_PreState_Container_P = {
      val r = parsethermostatThermostat_PreState_Container_PT(F)
      return r
    }

    def parsethermostatThermostat_PreState_Container_PT(typeParsed: B): thermostat.Thermostat_PreState_Container_P = {
      if (!typeParsed) {
        parser.parseObjectType("thermostat.Thermostat_PreState_Container_P")
      }
      parser.parseObjectKey("api_lower_alarm_tempWstatus")
      val api_lower_alarm_tempWstatus = parseIsolette_Data_ModelTempWstatus_impl()
      parser.parseObjectNext()
    ...
    def parsethermostatThermostat_PostState_Container(): thermostat.Thermostat_PostState_Container = {
      val t = parser.parseObjectTypes(ISZ("thermostat.Thermostat_PostState_Container_P"))
      t.native match {
        case "thermostat.Thermostat_PostState_Container_P" => val r = parsethermostatThermostat_PostState_Container_PT(T); return r
        case _ => val r = parsethermostatThermostat_PostState_Container_PT(T); return r
      }
    }

    def parsethermostatThermostat_PostState_Container_P(): thermostat.Thermostat_PostState_Container_P = {
      val r = parsethermostatThermostat_PostState_Container_PT(F)
      return r
    }

    def parsethermostatThermostat_PostState_Container_PT(typeParsed: B): thermostat.Thermostat_PostState_Container_P = {
      if (!typeParsed) {
        parser.parseObjectType("thermostat.Thermostat_PostState_Container_P")
      }
      parser.parseObjectKey("api_monitor_status")
      val api_monitor_status = parseIsolette_Data_ModelStatusType()
      parser.parseObjectNext()
      ...
      val api_heat_control = parseIsolette_Data_ModelOn_OffType()
      parser.parseObjectNext()
      parser.parseObjectKey("api_display_temp")
      val api_display_temp = parseIsolette_Data_ModelTemp_impl()
      parser.parseObjectNext()
      parser.parseObjectKey("api_regulator_status")
      val api_regulator_status = parseIsolette_Data_ModelStatusType()
      parser.parseObjectNext()
    ...
    def parsesystem_testsjohn1SystemTestsJohn__Container(): system_tests.john1.SystemTestsJohn__Container = {
      val r = parsesystem_testsjohn1SystemTestsJohn__ContainerT(F)
      return r
    }

    def parsesystem_testsjohn1SystemTestsJohn__ContainerT(typeParsed: B): system_tests.john1.SystemTestsJohn__Container = {
      if (!typeParsed) {
        parser.parseObjectType("system_tests.john1.SystemTestsJohn__Container")
      }
  ...
  def fromthermostatThermostat_PreState_Container(o: thermostat.Thermostat_PreState_Container, isCompact: B): String = {
    val st = Printer.printthermostatThermostat_PreState_Container(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def tothermostatThermostat_PreState_Container(s: String): Either[thermostat.Thermostat_PreState_Container, Json.ErrorMsg] = {
    def fthermostatThermostat_PreState_Container(parser: Parser): thermostat.Thermostat_PreState_Container = {
      val r = parser.parsethermostatThermostat_PreState_Container()
      return r
    }
    val r = to(s, fthermostatThermostat_PreState_Container _)
    return r
  }

  def fromthermostatThermostat_PreState_Container_P(o: thermostat.Thermostat_PreState_Container_P, isCompact: B): String = {
    val st = Printer.printthermostatThermostat_PreState_Container_P(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def tothermostatThermostat_PreState_Container_P(s: String): Either[thermostat.Thermostat_PreState_Container_P, Json.ErrorMsg] = {
    def fthermostatThermostat_PreState_Container_P(parser: Parser): thermostat.Thermostat_PreState_Container_P = {
      val r = parser.parsethermostatThermostat_PreState_Container_P()
      return r
    }
    val r = to(s, fthermostatThermostat_PreState_Container_P _)
    return r
  }

  def fromthermostatThermostat_PostState_Container(o: thermostat.Thermostat_PostState_Container, isCompact: B): String = {
    val st = Printer.printthermostatThermostat_PostState_Container(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def tothermostatThermostat_PostState_Container(s: String): Either[thermostat.Thermostat_PostState_Container, Json.ErrorMsg] = {
    def fthermostatThermostat_PostState_Container(parser: Parser): thermostat.Thermostat_PostState_Container = {
      val r = parser.parsethermostatThermostat_PostState_Container()
      return r
    }
    val r = to(s, fthermostatThermostat_PostState_Container _)
    return r
  }

  def fromthermostatThermostat_PostState_Container_P(o: thermostat.Thermostat_PostState_Container_P, isCompact: B): String = {
    val st = Printer.printthermostatThermostat_PostState_Container_P(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def tothermostatThermostat_PostState_Container_P(s: String): Either[thermostat.Thermostat_PostState_Container_P, Json.ErrorMsg] = {
    def fthermostatThermostat_PostState_Container_P(parser: Parser): thermostat.Thermostat_PostState_Container_P = {
      val r = parser.parsethermostatThermostat_PostState_Container_P()
      return r
    }
    val r = to(s, fthermostatThermostat_PostState_Container_P _)
    return r
  }

  def fromsystem_testsjohn1SystemTestsJohn__Container(o: system_tests.john1.SystemTestsJohn__Container, isCompact: B): String = {
    val st = Printer.printsystem_testsjohn1SystemTestsJohn__Container(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def tosystem_testsjohn1SystemTestsJohn__Container(s: String): Either[system_tests.john1.SystemTestsJohn__Container, Json.ErrorMsg] = {
    def fsystem_testsjohn1SystemTestsJohn__Container(parser: Parser): system_tests.john1.SystemTestsJohn__Container = {
      val r = parser.parsesystem_testsjohn1SystemTestsJohn__Container()
      return r
    }
