...
object TestIt_Example_Regulate_Subsystem_Inputs_Container_DSC_Test_Harness extends App {

  override def main(args: ISZ[String]): Z = {
    System.setProperty("TEST_FAMILY_NAME", "<key from testMatrix>")

    val instance = new Example_Regulate_Subsystem_Inputs_Container_DSC_Test_Harness()
...
class Example_Regulate_Subsystem_Inputs_Container_DSC_Test_Harness
  extends Example_Regulate_Subsystem_Inputs_Container_Test_wSlangCheck
